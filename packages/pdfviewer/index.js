...
export default class NtButton extends BaseComponent {
    ...
    class PDFLinkService {
      ...
      setHash(hash) {
        ...
        if (hash.includes('=')) {
          ...
          if (_this.search || params.has('search')) {
            const query =
                _this.search?.replaceAll('"', '') ??
                params.get('search').replaceAll('"', ''),
  ...
  resourceIds: ${JSON.stringify(this.resourceIds)}.`);
    ...
    function renderProgress(index, total) {
      dialog ||= shadowRoot.getElementById('printServiceDialog');
    ...
    function ensureOverlay() {
      if (!overlayPromise) {
        ...
        shadowRoot.getElementById('printCancel').onclick = abort;
    ...
    const PDFViewerApplication = {
      ...
      async run(config) {
        ...
        file = _this.file ?? params.get('file') ?? AppOptions.get('defaultUrl');
      ...
      get loadingBar() {
        const barElement = shadowRoot.getElementById('loadingBar');
    ...
    function getViewerConfiguration() {
      return {
        ...
        mainContainer: shadowRoot.getElementById('viewerContainer'),
        viewerContainer: shadowRoot.getElementById('viewer'),
        toolbar: {
          container: shadowRoot.getElementById('toolbarViewer'),
          numPages: shadowRoot.getElementById('numPages'),
          pageNumber: shadowRoot.getElementById('pageNumber'),
          scaleSelect: shadowRoot.getElementById('scaleSelect'),
          customScaleOption: shadowRoot.getElementById('customScaleOption'),
          previous: shadowRoot.getElementById('previous'),
          next: shadowRoot.getElementById('next'),
          zoomIn: shadowRoot.getElementById('zoomIn'),
          zoomOut: shadowRoot.getElementById('zoomOut'),
          viewFind: shadowRoot.getElementById('viewFind'),
        ...
        secondaryToolbar: {
          toolbar: shadowRoot.getElementById('secondaryToolbar'),
          toggleButton: shadowRoot.getElementById('secondaryToolbarToggle'),
          presentationModeButton: shadowRoot.getElementById('presentationMode'),
          openFileButton: shadowRoot.getElementById('secondaryOpenFile'),
          printButton: shadowRoot.getElementById('secondaryPrint'),
          downloadButton: shadowRoot.getElementById('secondaryDownload'),
          viewBookmarkButton: shadowRoot.getElementById('viewBookmark'),
          firstPageButton: shadowRoot.getElementById('firstPage'),
          lastPageButton: shadowRoot.getElementById('lastPage'),
          pageRotateCwButton: shadowRoot.getElementById('pageRotateCw'),
          pageRotateCcwButton: shadowRoot.getElementById('pageRotateCcw'),
          cursorSelectToolButton: shadowRoot.getElementById('cursorSelectTool'),
          cursorHandToolButton: shadowRoot.getElementById('cursorHandTool'),
          scrollPageButton: shadowRoot.getElementById('scrollPage'),
          scrollVerticalButton: shadowRoot.getElementById('scrollVertical'),
          scrollHorizontalButton: shadowRoot.getElementById('scrollHorizontal'),
          scrollWrappedButton: shadowRoot.getElementById('scrollWrapped'),
          spreadNoneButton: shadowRoot.getElementById('spreadNone'),
          spreadOddButton: shadowRoot.getElementById('spreadOdd'),
          spreadEvenButton: shadowRoot.getElementById('spreadEven'),
          documentPropertiesButton:
            shadowRoot.getElementById('documentProperties'),
        },
        sidebar: {
          outerContainer: shadowRoot.getElementById('outerContainer'),
          sidebarContainer: shadowRoot.getElementById('sidebarContainer'),
          toggleButton: shadowRoot.getElementById('sidebarToggle'),
          resizer: shadowRoot.getElementById('sidebarResizer'),
          thumbnailButton: shadowRoot.getElementById('viewThumbnail'),
          outlineButton: shadowRoot.getElementById('viewOutline'),
          attachmentsButton: shadowRoot.getElementById('viewAttachments'),
          layersButton: shadowRoot.getElementById('viewLayers'),
          thumbnailView: shadowRoot.getElementById('thumbnailView'),
          outlineView: shadowRoot.getElementById('outlineView'),
          attachmentsView: shadowRoot.getElementById('attachmentsView'),
          layersView: shadowRoot.getElementById('layersView'),
          currentOutlineItemButton:
            shadowRoot.getElementById('currentOutlineItem'),
        },
        findBar: {
          bar: shadowRoot.getElementById('findbar'),
          toggleButton: shadowRoot.getElementById('viewFind'),
          findField: shadowRoot.getElementById('findInput'),
          ...
          findResultsCount: shadowRoot.getElementById('findResultsCount'),
          findPreviousButton: shadowRoot.getElementById('findPrevious'),
          findNextButton: shadowRoot.getElementById('findNext'),
        },
        passwordOverlay: {
          dialog: shadowRoot.getElementById('passwordDialog'),
          label: shadowRoot.getElementById('passwordText'),
          input: shadowRoot.getElementById('password'),
          submitButton: shadowRoot.getElementById('passwordSubmit'),
          cancelButton: shadowRoot.getElementById('passwordCancel'),
        },
        documentProperties: {
          dialog: shadowRoot.getElementById('documentPropertiesDialog'),
          closeButton: shadowRoot.getElementById('documentPropertiesClose'),
          fields: {
            fileName: shadowRoot.getElementById('fileNameField'),
            fileSize: shadowRoot.getElementById('fileSizeField'),
            title: shadowRoot.getElementById('titleField'),
            author: shadowRoot.getElementById('authorField'),
            subject: shadowRoot.getElementById('subjectField'),
            ...
            version: shadowRoot.getElementById('versionField'),
            pageCount: shadowRoot.getElementById('pageCountField'),
            pageSize: shadowRoot.getElementById('pageSizeField'),
            linearized: shadowRoot.getElementById('linearizedField'),
          },
        },
        altTextDialog: {
          dialog: shadowRoot.getElementById('altTextDialog'),
          optionDescription: shadowRoot.getElementById('descriptionButton'),
          optionDecorative: shadowRoot.getElementById('decorativeButton'),
          textarea: shadowRoot.getElementById('descriptionTextarea'),
          cancelButton: shadowRoot.getElementById('altTextCancel'),
          saveButton: shadowRoot.getElementById('altTextSave'),
        },
        annotationEditorParams: {
          ...
          editorInkThickness: shadowRoot.getElementById('editorInkThickness'),
